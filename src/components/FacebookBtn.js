...
const FacebookLoginButton = () => {
    const handleFacebookSignUp = async () => {
        try {
          const provider = new FacebookAuthProvider(); // Create a new instance of the FacebookAuthProvider
          const result = await signInWithPopup(auth, provider); // Pass the auth instance and the provider to signInWithPopup
